  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          "Vous pouvez demander à tout moment la suppression de votre compte Cerebrum et de l'ensemble des données associées. Cerebrum est édité par Synapgeek SAS, 185 Chemin des Brosses, 69620 Frontenas, France.\n\n**Option 1 — Dans l'Application (immédiat)**\nOuvrez l'Application, allez dans **Profil**, puis touchez **Supprimer le compte** et confirmez. La suppression est immédiate et définitive.\n\n**Option 2 — Sans l'Application**\nSi vous n'avez plus l'Application installée, adressez-nous votre demande via notre formulaire de contact à l'adresse https://synapgeek.com/#contact, ou par e-mail à privacy@synapgeek.com.\n\nUtilisez l'adresse e-mail rattachée à votre compte et précisez le nom de l'application (Cerebrum) ainsi que le fournisseur de connexion utilisé (Google, Apple ou Facebook). Nous vérifions votre identité avant de donner suite à toute demande, et pouvons vous demander un élément complémentaire pour nous en assurer.\n\n**Comptes invités (utilisation sans connexion)**\nSi vous avez joué sans vous connecter, vos données sont rattachées à un identifiant technique généré par votre appareil : nous ne détenons aucune adresse e-mail ni aucun autre moyen de vous identifier. Attention, **désinstaller l'Application ne supprime pas ces données de nos serveurs.**\n\nPour les effacer, ouvrez l'Application et connectez-vous avec Google, Apple ou Facebook : votre progression existante reste rattachée au même compte. Vous pouvez ensuite utiliser **Profil > Supprimer le compte**.\n\n**Ce qui est supprimé**\nVotre compte d'authentification, votre progression et les niveaux débloqués, votre XP, vos trophées et votre ligue, votre série quotidienne, votre portefeuille de pièces, vos avatars, vos parties en cours, ainsi que vos entrées dans les classements.\n\n**Ce qui n'est pas supprimé**\nLes statistiques agrégées et anonymisées, qui ne peuvent pas être rattachées à vous et ne peuvent donc pas être supprimées individuellement. Les données analytiques suivent la durée de conservation indiquée à la section « Conservation des données » ci-dessous. Les données de facturation des achats intégrés sont détenues par Google Play et Apple, et non par nous — adressez-vous directement à eux pour celles-ci.\n\n**Délai**\nLa suppression dans l'Application est immédiate. Les demandes qui nous sont adressées sont traitées sous 30 jours au maximum.\n\n**Cette action est définitive.** Les données supprimées ne peuvent pas être restaurées et les achats intégrés ne sont pas remboursés.",
      },
      {
        title: "Données collectées et sources",
        content:
          "Nous collectons les catégories de données suivantes :\n\n**Données de compte**\nSi vous créez un compte via Apple, Google ou Facebook : identifiant unique, adresse email, nom d'affichage et photo de profil (selon le fournisseur). Vous pouvez également utiliser l'Application sans compte (mode anonyme).\n\n**Données de jeu et de progression**\nScores, temps de complétion, indices utilisés, erreurs, étoiles obtenues, niveaux complétés, niveau de difficulté, tentatives, meilleurs records, défis quotidiens, séries de jeu (streaks).\n\n**Données de monnaie virtuelle et de personnalisation**\nSolde de pièces, historique de transactions in-app, avatars débloqués, trophées mensuels, points d'expérience (XP), ligue/classement.\n\n**Données d'appareil et d'utilisation**\nType d'appareil, version du système d'exploitation, langue, données d'utilisation anonymisées, diagnostics, journaux d'erreur, données de performance applicative.\n\n**Données publicitaires**\nIdentifiant publicitaire (IDFA sur iOS, avec votre consentement via App Tracking Transparency ; AAID sur Android, sous réserve du consentement recueilli au premier lancement), interactions avec les publicités, données d'attribution via SKAdNetwork sur iOS.\n\n**Données de transaction**\nHistorique des achats in-app et abonnements, traités par Apple via StoreKit 2 sur iOS et par Google Play Billing sur Android. Synapgeek ne collecte ni ne stocke vos informations de paiement.\n\n**Données que nous ne collectons PAS**\nNous ne collectons aucune donnée de géolocalisation, de santé, de contacts, de photos, de caméra, de calendrier ni de microphone.",
      },
      {
